...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="Dashboard_assets/images/favicon.png" />
</head>
<body>
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/ui-features/buttons.html">Buttons</a></li>
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/ui-features/typography.html">Typography</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_assets/pages/forms/basic_elements.html">
            <i class="mdi mdi-view-headline menu-icon"></i>
            <span class="menu-title">Form elements</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_assets/pages/charts/chartjs.html">
            <i class="mdi mdi-chart-pie menu-icon"></i>
            <span class="menu-title">Charts</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_assets/pages/tables/basic-table.html">
            <i class="mdi mdi-grid-large menu-icon"></i>
            <span class="menu-title">Tables</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_assets/pages/icons/mdi.html">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/samples/login.html"> Login </a></li>
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/samples/login-2.html"> Login 2 </a></li>
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/samples/register.html"> Register </a></li>
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/samples/register-2.html"> Register 2 </a></li>
              <li class="nav-item"> <a class="nav-link" href="Dashboard_assets/pages/samples/lock-screen.html"> Lockscreen </a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item sidebar-category">
        ...
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_assets/docs/documentation.html">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="index.html"><img src="Dashboard_assets/images/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="Dashboard_assets/images/logo-mini.svg" alt="logo"/></a>
          </div>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="Dashboard_assets/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="Dashboard_assets/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="Dashboard_assets/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <img src="Dashboard_assets/images/faces/face5.jpg" alt="profile"/>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face1.jpg" alt="image"/>
                          </td>
                          <td>
                            Herman Beck
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face2.jpg" alt="image"/>
                          </td>
                          <td>
                            Messsy Adam
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face3.jpg" alt="image"/>
                          </td>
                          <td>
                            John Richards
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face4.jpg" alt="image"/>
                          </td>
                          <td>
                            Peter Meggik
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face5.jpg" alt="image"/>
                          </td>
                          <td>
                            Edward
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face6.jpg" alt="image"/>
                          </td>
                          <td>
                            John Doe
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="Dashboard_assets/images/faces/face7.jpg" alt="image"/>
                          </td>
                          <td>
                            Henry Tom
                          </td>
